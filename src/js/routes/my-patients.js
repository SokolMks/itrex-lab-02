export const patients = `
 <section class="doctor-view">
    <div class="doctor-account">
      <div class="doctor-account-header">
        <object data="./images/logo-title.svg" width="132" height="32"></object>
        <!-- <h2 class="doctor-account-clinic-title">Palm Clinic</h2> -->
        <div class="doctor-account-user">
          <div class="doctor-account-user-description">
            <p class="doctor-account-user-name">Miranda Nelson <span></span></p>
            <p class="doctor-account-user-position">Doctor</p>
          </div>
          <img src="./images/faces/avatar.png" alt="Users photograph">
        </div>
      </div>
      <div class="doctor-wrapper">
        <ul class="doctor-pages">
          <li class=""><button class="doctor-page doctor-page-active">Patients</button></li>
          <li class=""><button class="doctor-page">Resolutions</button></li>
        </ul>
        <div class="doctor-account-patients">
          <div class="doctor-account-patients-list">
            <h2 class="doctor-account-page-title">My Patients</h2>
            <form action="" class="doctor-account-search-form">
          ...
          <div class="doctor-wrapper-patients">
            <ul class="doctor-wrapper-patients-list">
              <li class="doctor-wrapper-patients-list-patient">
                <div class="patient-header">
                  <img src="./images/faces/face1.png" width="48" height="48" alt="Patients photograph">
                  <div class="patient-header-info">
                    <h3 class="patient-name">Jane Cooper</h3>
                    <div class="patient-appointment">
                      <svg class="patient-appointment-indicator patient-appointment-indicator-confirmed" width="8" height="8"
                            viewBox="0 0 8 8" xmlns="http://www.w3.org/2000/svg">
                              <ellipse cx="3.95637" cy="4" rx="3.95637" ry="4" />
                      </svg>
                      <p class="patient-appointment-status">Appointment is confirmed</p>
                    </div>
                  </div>
                  <button class="patient-manage">
                    <svg width= "24" height="24" fill= "none" viewBox="0 0 24 24">
                      <path d="M12 6C12.5523 6 13 5.55228 13 5C13 4.44772 12.5523 4 12 4C11.4477 4 11 4.44772 11 5C11 5.55228 11.4477 6 12 6Z"
                            stroke="#DCE0EC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                      <path
                    ...
                    <div>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                          ...
                          fill="white" stroke="#DCE0EC" />
                      </svg>
                    </div>
                    <p class="patient-appointment-details-date">Thu Sept 10, 2021 4pm - 5pm</p>
                  </div>
                  <div class="patient-appointment-details">
                    <div class="patient-appointment-details-icon">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <p class="patient-appointment-details-message">We will invite you in for a full review every year and more frequently if you are struggling with blood sugar levels</p>
                  </div>
                </div>
              </li>
              <li class="doctor-wrapper-patients-list-patient">
                <div class="patient-header">
                  <img src="./images/faces/face2.png" width="48" height="48" alt="Patients photograph">
                  <div class="patient-header-info">
                    <h3 class="patient-name">Arlene McCoy</h3>
                    <div class="patient-appointment">
                      <svg class="patient-appointment-indicator patient-appointment-indicator-canceled" width="8" height="8" viewBox="0 0 8 8"
                        xmlns="http://www.w3.org/2000/svg">
                        <ellipse cx="3.95637" cy="4" rx="3.95637" ry="4" />
                      </svg>
                      <p class="patient-appointment-status">Appointment is canceled</p>
                    </div>
                  </div>
                  <button class="patient-manage">
                    <svg width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <div class="patient-appointment-details">
                    ...
                    <p class="patient-appointment-details-message">We will invite you in for a full review every year and more
              ...
              <li class="doctor-wrapper-patients-list-patient">
                <div class="patient-header">
                  <img src="./images/faces/face3.png" width="48" height="48" alt="Patients photograph">
                  <div class="patient-header-info">
                    <h3 class="patient-name">Annette Black</h3>
                    <div class="patient-appointment">
                      <svg class="patient-appointment-indicator patient-appointment-indicator-pending" width="8" height="8" viewBox="0 0 8 8"
                        xmlns="http://www.w3.org/2000/svg">
                        <ellipse cx="3.95637" cy="4" rx="3.95637" ry="4" />
                      </svg>
                      <p class="patient-appointment-status">Waiting for confirmation...</p>
                    </div>
                  </div>
                  <button class="patient-manage">
                    <svg width="24" height="24" fill="none" viewBox="0 0 24 24">
